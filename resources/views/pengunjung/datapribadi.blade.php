                                        ...
                                        <table border="0" width="100%" style="padding-left: 2px; padding-right: 13px;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="2%">:</td>
                                                    <td>
                                                        <input type="text" id="username" value="{{$pengunjung->nama}}"
                                                            class="form-control " name="username" placeholder="Nama"
                                                            required>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <input type="text" id="email" value="{{$pengunjung->email}}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <input type="text" id="no_telp" value="{{$pengunjung->no_telp}}"
                                                            class="form-control " name="no_telp" placeholder="No Telp"
                                                            required>
