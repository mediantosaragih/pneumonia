            ...
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row" style="margin-bottom: 200px; text-align:center">
                  <div class="col-lg-12" >
                    <p class="display-3">Selamat Datang di</p>
                    <p class="display-6">Sistem Identifikasi Kepribadian dengan Metode Forward Chaining </p>
                  </div>
                  <div class="col-lg-12" style="padding: 1x; ">
                    <div class="white-button first-button scroll-to-section">
                      <a href=" {{url('diagnosa')}}">Cek Sekarang <i class="fa fa-search"></i></a>
                    </div>
                  </div>
                </div>
              </div>
