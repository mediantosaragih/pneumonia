            ...
            <div class="modal-dialog">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="inputName">Kode Gejala</label>
                        <input type="text" class="form-control" id="inputName" placeholder="Enter your Kode Gejala"/>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail">Nama Gejala</label>
